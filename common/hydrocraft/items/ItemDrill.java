...
import hydrocraft.items.ItemHydrocraftTool.ToolType;
...
public class ItemDrill extends ItemHydrocraftTool implements IRechargeable{

	public ItemDrill(int par1) {
		super(par1, "drill", ToolType.MECHANICAL, blocksEffectiveAgainst);
	}
