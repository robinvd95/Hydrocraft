...
public class BlockFluidExtractor extends BlockContainer{
	...
	public BlockFluidExtractor(int par1, Material par2Material) {
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9){
		TileEntityFluidExtractor var1 = (TileEntityFluidExtractor) par1World.getBlockTileEntity(par2, par3, par4);
		if(var1 != null){
			par5EntityPlayer.openGui(BaseHydrocraft.instance, 3, par1World, par2, par3, par4);
			return true;
		}
		return false;
	}
